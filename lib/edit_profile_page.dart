...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _changePassword() async {
    ...
    if (result == true) {
      ...
      if (user != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Функция смены пароля временно недоступна')),
        );
      }
    }
  }
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const SizedBox(height: 5), // минимальный отступ сверху
                // Аватар (уменьшен до 100x100)
                GestureDetector(
                ...
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(12.0), // уменьшен padding
                    child: Column(
                      children: [
                        TextField(
                ...
                const SizedBox(height: 5), // небольшой запас снизу
              ],
            ),
          ),
        ),
