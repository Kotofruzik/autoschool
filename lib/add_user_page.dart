...
class _AddUserPageState extends State<AddUserPage> {
  ...
  Future<void> _createUser() async {
    ...
    try {
      ...
      if (success) {
        // Если есть фото, загружаем его (нужен метод в провайдере)
        if (_newCroppedImage != null) {
          // Здесь нужно вызвать метод загрузки фото для созданного пользователя.
          // Пока у нас нет такого метода, поэтому пропустим или добавим позже.
          // В идеале – передать ID созданного пользователя и загрузить фото.
