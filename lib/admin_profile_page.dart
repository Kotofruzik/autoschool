    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Stack(
            children: [
              // Контент прижат к верху и отцентрирован по горизонтали
              Align(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Аватар (без иконки камеры)
                      GestureDetector(
                        onTap: _editProfile, // можно убрать, если не нужно
                        child: Container(
                          width: 120,
                          height: 120,
              ...
              // Кнопка редактирования (карандаш) в правом верхнем углу
              Positioned(
                top: 16,
                right: 16,
                child: IconButton(
